...
let private CookieBanner =
    [
        div [ _class "govuk-cookie-banner"; attr "_role" "region"; _ariaLabel "Cookies on the UK Coronavirus Dashboard"
              _id "cookie-banner";  _style "visibility: hidden; display: none" ] [
            div [ _class "govuk-width-container" ] [
                div [ _class "govuk-cookie-banner__message govuk-!-width-two-thirds" ] [
                    div [ _class "govuk-grid-row" ] [
                        div [ _class "govuk-grid-column-two-thirds" ] [
                            h2 [] [ encodedText "Cookies on the UK Coronavirus Dashboard" ]
                            
                            div [ _class "govuk-cookie-banner__content" ] [
                                p [ _class "govuk-body" ] [
                                    encodedText "We use some essential cookies to make this service work."
                                ]
                                p [ _class "govuk-body" ] [
                    ...
                    div [ _class "govuk-button-group"] [
                        button [
                            _class "gem-c-button govuk-button gem-c-button--inline"
                            _type "submit"
                            _id "accept-cookies"
                            attr "data-module" "track-click"
                            attr "data-accept-cookies" "true"
                            attr "data-track-category" "cookieBanner"
                        ] [
                            encodedText "Accept additional cookies"
                        ]
                        button [
                            _class "gem-c-button govuk-button gem-c-button--inline"
                            _type "submit"
                            attr "data-module" "track-click"
                            attr "data-set-cookie-preferences" "true"
                            _id "reject-cookies"
                            attr "_data-track-category" "cookieBanner"
                            attr "onClick" "javascript:handleSetCookiePreferences()"
                        ] [
                            encodedText "Reject additional cookies"
                        ]
                        a [
                            _href "/details/cookies"
                            _class "govuk-link govuk-body"
                        ] [
                            encodedText "View cookies"
                        ]
                    ]
                ]
            ]
        ...
        div [
            _id "global-cookie-message"
            _class "gem-c-cookie-banner govuk-clearfix"
            attr "_role" "region"
            attr "aria-label" "cookie banner"
            _style "display: none; visibility: hidden;"
        ] [
            div [
                _class "gem-c-cookie-banner__confirmation govuk-width-container"
                attr "_tabIndex" "-1"
            ] [
                ...
                button [
                    _class "gem-c-cookie-banner__hide-button govuk-link"
                    _id "hide-cookie-decision"
                    _type "button"
                ] [ encodedText "Hide" ]
            ]
        ]
